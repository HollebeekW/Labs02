...
Route::get('games/{game}/history', [\App\Http\Controllers\GameController::class, 'showHistory'])->name('games.history');
Route::get('games/{game}/results', [\App\Http\Controllers\GameController::class, 'showResults'])->name('games.results');
